<div class="migrate-tab content-tab">
	<p class="saved-migration-profile-label"><?php _e( 'Would you like to use a saved migration profile?', 'wp-shift-db' ); ?></p>
	<ul class="migration-profile-options">
		...
		<?php } ?>
		<li><a href="<?php echo $this->plugin_base , '&wpsdb-profile=-1'; ?>"><?php _e( 'Nope, let\'s start fresh...', 'wp-shift-db' ); ?></a></li>
	</ul>
</div>
